...
public class Brick_RectangularCone : Brick
{
	// mesh
	...
	{
		vertLeftTopFront = new Vector3(0, 0, 0);
		vertRightTopFront = new Vector3(0, 0, 0);
		vertRightTopBack = new Vector3(0, 0, 0);
		vertLeftTopBack = new Vector3(0, 0, 0);
		UpdateMeshShape();
	}
