...
public class Brick_Cone : Brick
{
    ...
    private void ChangeMeshToCone()
	{
		vertLeftTopFront = new Vector3(0, osl, osl);
		vertRightTopFront = new Vector3(0, osl, osl);
		vertRightTopBack = new Vector3(0, osl, -osl);
		vertLeftTopBack = new Vector3(0, osl, -osl);
		UpdateMeshShape();
	}
