...
public class ColorPickerForGridSettings : MonoBehaviour
{
    /// <summary>
    ...
    public static ColorPickerForGridSettings instance; // 2020/09/06 private -> public
    /// <returns>
    ...
    public static bool Create(Color original, string message, ColorEvent onColorChanged, ColorEvent onColorSelected, bool useAlpha = false)
    {
        ...
        if (done)
        {
            ...
            //PalletColorPickerMouseEventDetector.instance.gameObject.SetActive(true);
            //instance.transform.GetChild(0).GetChild(0).GetComponent<Text>().text = message; // todo -> change to pop up text box
